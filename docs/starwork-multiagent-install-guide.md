...
`--full-depth` 不能省略：`starworkMultiagent` 的长流程已经拆到 `references/`，安装时必须把完整目录带上。
...
```bash
npx skills add https://github.com/jennie-shawn/StarWork/tree/main/skills --skill starwork --full-depth -g -a codex -y
npx skills add https://github.com/jennie-shawn/StarWork/tree/main/skills --skill starworkInit --full-depth -g -a codex -y
npx skills add https://github.com/jennie-shawn/StarWork/tree/main/skills --skill starworkDoctor --full-depth -g -a codex -y
npx skills add https://github.com/jennie-shawn/StarWork/tree/main/skills --skill starworkMultiagent --full-depth -g -a codex -y
```
...
2. `npx skills add https://github.com/jennie-shawn/StarWork/tree/main/skills --skill starworkMultiagent -g -a codex -y` 是否仍是单独安装 MultiAgent Skill 的正确命令？
